...
namespace StudentskaSluzba2.Controllers
{
    public class ProfesorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Prof,Ime,Prezime")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Prof,Ime,Prezime")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
